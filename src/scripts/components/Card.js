class Card {
    constructor({ id, data, handleCardClick, handleLikeClick, handleDeleteIconClick }, cardSelector) {
        this._userId = id;
    ...
    generateCard() {
        ...
        this._delBtn.classList.add(this._userId === this._ownerId ? 'card__del_visible' : 'card__del_hidden');
    ...
    _setEventListeners() {
        ...
        this._delBtn.addEventListener('click', () => this._handleDeleteIconClick(this._cardId));
    }
